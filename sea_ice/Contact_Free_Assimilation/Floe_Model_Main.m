...
for i = 2:N
    ...
    distance_x2 = abs(x(:,i-1) * ones(1,L) - ones(L,1) * x(:,i-1)' + 50); % dealing with the floes near the boundaries
    distance_x3 = abs(x(:,i-1) * ones(1,L) - ones(L,1) * x(:,i-1)' - 50); % dealing with the floes near the boundaries
    ...
    distance_y2 = abs(y(:,i-1) * ones(1,L) - ones(L,1) * y(:,i-1)' + 50); % dealing with the floes near the boundaries
    distance_y3 = abs(y(:,i-1) * ones(1,L) - ones(L,1) * y(:,i-1)' - 50); % dealing with the floes near the boundaries
